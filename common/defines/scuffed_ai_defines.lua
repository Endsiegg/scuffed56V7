...
NDefines.NAI.HOUR_BAD_COMBAT_REEVALUATE = 72                  -- reduced from 168 ; if we are in combat for this amount and it goes shitty then try skipping it 
...
NDefines.NAI.GENERATE_WARGOAL_ANTAGONIZE_SCALE = 0.4 -- (Original value: 0.35) How likely the AI acts on claims to generated war goals. Baseline is 'min_threat - antagonize * scale.' So don't lower it below 0.25! 
...
NDefines.NAI.CONSTRUCTION_PRIO_FACTOR_REPAIRING = 0.50                                  -- factor prio with this if building is being repaired
-- <end> construction prioritization

NDefines.NAI.TRADEABLE_FACTORIES_FRACTION = 0.7
--NDefines.NAI.MIN_DELIVERED_TRADE_FRACTION = 0.6

--NDefines.NAI.ESTIMATED_CONVOYS_PER_DIVISION = 6

NDefines.NAI.WAIT_YEARS_BEFORE_FREER_BUILDING = 2

NDefines.NAI.DOCKYARDS_PER_NAVAL_DESIRE_EFFECT = -80.0
...
NDefines.NAI.PLAN_FACTION_STRONG_TO_EXECUTE = 0.65 --0.80	0.60	
...
NDefines.NAI.ATTACK_HEAVILY_DEFENDED_LIMIT = 0.7			-- reduced from 1.0 ; AI will not launch attacks against heavily defended fronts unless they consider to have this level of advantage (1.0 = 100%)
...
NDefines.NAI.DESPERATE_AI_MIN_ORG_BEFORE_ATTACK = 0.8					-- ai will wait for this much org to attack an enemy prov in desperate situations
